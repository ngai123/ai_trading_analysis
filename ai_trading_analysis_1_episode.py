...
def main():
    try:
        ...
        # Train the DQN model (limited to 1 episode for quick testing)
        trading_system.train_dqn(num_episodes=1)  # Set to 1 for quick testing, increase as needed
        
        # Define the save directory (adjust this path as needed)
        save_directory = "saved_models"  # Replace with your desired directory
        ...
        scaler_data = {
            "min_": trading_system.price_scaler.min_.tolist(),  # Convert numpy array to list for JSON
